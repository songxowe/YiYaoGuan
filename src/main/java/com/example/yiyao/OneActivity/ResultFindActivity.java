...
public class ResultFindActivity extends AppCompatActivity {
    ...
    //折扣
    private String conditions="discount";
    private TextView tvBack;
    private EditText txtInputResult;
    ...
    private void getTotal() {
        ...
        StringRequest request = new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
            ...
            public void onErrorResponse(VolleyError volleyError) {
                TmallUtils.showToast(ResultFindActivity.this, "无网络,请连接网络");
            }
        }) {
            @Override
    ...
    private void getDateFromService() {
        //编辑框中的条件变量
        condition = txtInputResult.getText().toString();
        ...
        NetService.getInstance(this).addToRequestQueue(stringRequest, "result");
    }
    ...
    private void initView() {
        ...
        tvBack = (TextView) findViewById(R.id.result_tv_return);
        txtInputResult = (EditText) findViewById(R.id.txt_input_result);
    ...
    private void EditTextEvent() {
        ...
        //获取从查找页面的值.
        condition = intent.getStringExtra("find");
        txtInputResult.setText(condition);
        txtInputResult.setOnFocusChangeListener(new View.OnFocusChangeListener() {
            @Override
        ...
        tvBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(ResultFindActivity.this, FindDrugActivity.class));
            }
        });
    }
    ...
    private void initDate() {
        ...
        adapter = new ZheKouAdapter(list, this);
        mAdapter = new RecyclerAdapterWithHF(adapter);
        recyclerView.setAdapter(mAdapter);
        mPtrFrame = (PtrClassicFrameLayout) findViewById(R.id.result_rotate_header_list_view_frame);
        //下拉刷新支持时间
        ...
        mPtrFrame.setOnLoadMoreListener(new OnLoadMoreListener() {
            ...
            public void loadMore() {
                ...
                if (page <= intTotalPage) {
                    ...
                    TmallUtils.showToast(ResultFindActivity.this, "没有更多的数据");
                }
    ...
    protected void onStop() {
        super.onStop();
        NetService.getInstance(this).cancelRequest("result");
