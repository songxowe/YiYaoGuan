...
//搜索感冒页面
public class FindGanmaoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_find_ganmao);
        initView();
        initDate();
        getTotal();
    }
    ...
    private void getTotal() {
        ...
        StringRequest request = new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
            ...
            public void onErrorResponse(VolleyError volleyError) {
                TmallUtils.showToast(FindGanmaoActivity.this, "无网络,请连接网络");
            }
        }) {
            @Override
    ...
    private void getDateFromService() {
        ...
        NetService.getInstance(this).addToRequestQueue(stringRequest, "ganmao");
    }
    ...
    private void initView() {
        recyclerView = (RecyclerView) findViewById(R.id.ganmao_recyclerView);
    ...
    private void initDate() {
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(FindGanmaoActivity.this, FindDrugActivity.class));
            }
        });
        ...
        mPtrFrame = (PtrClassicFrameLayout) findViewById(R.id.ganmao_rotate_header_list_view_frame);
        //下拉刷新支持时间
        ...
        mPtrFrame.setOnLoadMoreListener(new OnLoadMoreListener() {
            ...
            public void loadMore() {
                ...
                if (page <= intTotalPage) {
                    ...
                    TmallUtils.showToast(FindGanmaoActivity.this, "没有更多的数据");
                }
    ...
    protected void onStop() {
        ...
        NetService.getInstance(this).cancelRequest("ganmao");
    }
