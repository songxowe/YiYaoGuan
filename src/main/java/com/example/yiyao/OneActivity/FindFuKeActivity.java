...
//搜索妇科页面
public class FindFuKeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_find_fu_ke);
        initView();
        initDate();
        getTotal();
    }
    ...
    private void getTotal() {
        ...
        StringRequest request = new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
            ...
            public void onErrorResponse(VolleyError volleyError) {
                TmallUtils.showToast(FindFuKeActivity.this, "无网络,请连接网络");
            }
        }) {
            @Override
    ...
    private void getDateFromService() {
        ...
        NetService.getInstance(this).addToRequestQueue(stringRequest, "fuke");
    }
    ...
    private void initView() {
        recyclerView = (RecyclerView) findViewById(R.id.fuke_recyclerView);
    ...
    private void initDate() {
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(FindFuKeActivity.this, FindDrugActivity.class));
            }
        });
        ...
        mPtrFrame = (PtrClassicFrameLayout) findViewById(R.id.fuke_rotate_header_list_view_frame);
        //下拉刷新支持时间
        ...
        mPtrFrame.setOnLoadMoreListener(new OnLoadMoreListener() {
            ...
            public void loadMore() {
                ...
                if (page <= intTotalPage) {
                    ...
                    TmallUtils.showToast(FindFuKeActivity.this, "没有更多的数据");
                }
    ...
    protected void onStop() {
        ...
        NetService.getInstance(this).cancelRequest("fuke");
    }
}
