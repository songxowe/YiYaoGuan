...
//搜索九芝堂
public class SearchShenBaoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_search_shen_bao);
        initView();
        initDate();
        getTotal();
    }
    ...
    private void getTotal() {
        ...
        StringRequest request = new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
            ...
            public void onErrorResponse(VolleyError volleyError) {
                TmallUtils.showToast(SearchShenBaoActivity.this, "无网络,请连接网络");
            }
        }) {
            @Override
    ...
    private void initDate() {
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(SearchShenBaoActivity.this, FindDrugActivity.class));
            }
        });
        ...
        mPtrFrame = (PtrClassicFrameLayout) findViewById(R.id.shenbao_rotate_header_list_view_frame);
        //下拉刷新支持时间
        ...
        mPtrFrame.setOnLoadMoreListener(new OnLoadMoreListener() {
            ...
            public void loadMore() {
                ...
                if (page <= intTotalPage) {
                    ...
                    TmallUtils.showToast(SearchShenBaoActivity.this, "没有更多的数据");
                }
