...
//搜索阿胶品牌节目
public class SearchAjiaoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_search_ajiao);
        initView();
        initDate();
        getTotal();
    }
    ...
    private void getTotal() {
        ...
        StringRequest request = new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
            ...
            public void onErrorResponse(VolleyError volleyError) {
                TmallUtils.showToast(SearchAjiaoActivity.this, "无网络,请连接网络");
            }
        }) {
            @Override
    ...
    private void getDateFromService() {
        ...
        NetService.getInstance(this).addToRequestQueue(stringRequest, "donge");
    }
    ...
    private void initView() {
        ...
        recyclerView = (RecyclerView) findViewById(R.id.ajiao_recyclerView);
    }
    ...
    private void initDate() {
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(SearchAjiaoActivity.this, FindDrugActivity.class));
            }
        });
        ...
        mPtrFrame = (PtrClassicFrameLayout) findViewById(R.id.ajiao_rotate_header_list_view_frame);
        //下拉刷新支持时间
        ...
        mPtrFrame.setOnLoadMoreListener(new OnLoadMoreListener() {
            ...
            public void loadMore() {
                ...
                if (page <= intTotalPage) {
                    ...
                    TmallUtils.showToast(SearchAjiaoActivity.this, "没有更多的数据");
                }
    ...
    public void onStop() {
        super.onStop();
        NetService.getInstance(this).cancelRequest("donge");
