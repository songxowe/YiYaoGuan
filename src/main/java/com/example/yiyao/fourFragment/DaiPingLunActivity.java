...
import com.example.yiyao.Adapter.DDXiangQingPjAdapter;
...
public class DaiPingLunActivity extends AppCompatActivity {
    ...
    private DDXiangQingPjAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dai_ping_lun);
        initView();
        initDate();
        getDateFromService();
    }
    ...
    private void initView() {
        ...
        shezhireturn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                DaiPingLunActivity.this.finish();
            }
        });
    }
    ...
    private void initDate() {
        ...
        oId = of.getO_id();
        data = new ArrayList<>();
        adapter = new DDXiangQingPjAdapter(this, data);
    ...
    protected void onDestroy() {
        ...
        NetService.getInstance(this).cancelRequest("evaluate");
    }
        ...
        switch (view.getId()) {
            ...
            case R.id.btn_ddxq_pay:
                ...
                if (adapter.getCount() < data.size()) {
                    TmallUtils.showToast(this, "还有商品未评价");
                } else {
                    st = "4";
                    ...
                    //改
                    /**
                    startActivity(new Intent(DaiPingLunActivity.this,MainActivity.class));
                    DaiPingLunActivity.this.finish();
                     **/
                }
    ...
    private void delData() {
        StringRequest request = new StringRequest(Request.Method.POST, NetService.getAbsoluteUrl("DeleteOrderformServlet"),
                    ...
                    public void onResponse(String s) {
                        try {
                            ...
                            if (result.equals("success")) {
                                ...
                                TmallUtils.showToast(DaiPingLunActivity.this, "成功删除！");
                            } else {
                                TmallUtils.showToast(DaiPingLunActivity.this, "删除失败！");
                            }
            ...
            @Override
            public void onErrorResponse(VolleyError volleyError) {
                TmallUtils.showToast(DaiPingLunActivity.this, "网络君失联喽！");
