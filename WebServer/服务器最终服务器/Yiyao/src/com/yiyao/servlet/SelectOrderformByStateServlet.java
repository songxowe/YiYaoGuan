...
/**
 * Servlet implementation class SelectOrderformByStateServlet
 */
public class SelectOrderformByStateServlet extends HttpServlet {
	 ...
	 */
	public SelectOrderformByStateServlet() {
		super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		// 按页数查询，并返回结果
		String json = "";
		List list = dao.findByState(u_id, o_state, pageno);
